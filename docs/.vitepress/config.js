    ...
    themeConfig: {
        nav: [
            ...
            },
            {
                text: 'PRO\'s',
                items: [
                    { text: '7 Step Catch-Up', link: '/professors/7-step-catch-up/' },
        ...
        sidebar: {
            ...
            '/professors/7-step-catch-up/': [
                {
                    text: '0 Call To Arms',
                    items: [
                        { text: 'Preface & First Task', link: '/professors/7-step-catch-up/0/preface' },
                    ]
                },
                {
                    text: '1 Editing',
                    items: [
                        { text: 'Video Fundementals', link: '/professors/7-step-catch-up/1/video-fundementals' },
                        { text: 'Software', link: '/professors/7-step-catch-up/1/software' },
                    ]
                },
                {
                    text: '2 Formats',
                    ...
                    collapsed: true,
                    items: [
                        { text: 'Superformat', link: '/professors/7-step-catch-up/2/superformat' },
                        { text: 'Clip Selection', link: '/professors/7-step-catch-up/2/clip-selection' },
                        { text: 'Finding Clips', link: '/professors/7-step-catch-up/2/finding-clips' },
                        { text: 'Music', link: '/professors/7-step-catch-up/2/music' },
                    ]
                },
                {
                    text: '3 Branding',
                    ...
                    collapsed: true,
                    items: [
                        { text: 'Username', link: '/professors/7-step-catch-up/3/username' },
                        { text: 'Profile Picture', link: '/professors/7-step-catch-up/3/profile-picture' },
                        { text: 'Biography', link: '/professors/7-step-catch-up/3/biography' },
                    ]
                },
                {
                    text: '4 Attack',
                    ...
                    collapsed: true,
                    items: [
                        { text: 'Posting', link: '/professors/7-step-catch-up/4/posting' },
                        { text: 'Marketing', link: '/professors/7-step-catch-up/4/username' },
                        { text: 'Marketing', link: '/professors/7-step-catch-up/4/username' },
                    ]
                },
                {
