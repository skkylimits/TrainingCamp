...
:root {
  ...
  --vp-c-brand-darker: var(--vp-c-red-darker);
...
:root {
  ...
  --vp-button-brand-hover-border: var(--vp-c-brand);
  --vp-button-brand-hover-text: var(--vp-c-white);
  --vp-button-brand-hover-bg: var(--vp-c-brand);
  --vp-button-brand-active-border: var(--vp-c-brand);
  --vp-button-brand-active-text: var(--vp-c-white);
  --vp-button-brand-active-bg: var(--vp-c-brand-darker);

  --vp-button-alt-border: var(--vp-c-brand);
  ...
  --vp-button-alt-hover-bg: var(--vp-c-brand);
